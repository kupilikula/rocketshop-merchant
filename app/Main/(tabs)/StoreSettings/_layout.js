...
export default function Layout() {
    ...
    return (
        <Stack
            ...
            <Stack.Screen name='Subscription' options={{header: ()=> <GenericHeader title='Subscription'/>}}/>
            <Stack.Screen name='StorePolicy' options={{header: ()=> <GenericHeader title='Store Policy'/>}}/>
        </Stack>
    );
}
