        ...
        <Card style={styles.offerCard}>
          <View style={styles.cardContent}>
            <View>
              ...
              >
                {item.applicableTo.products.length > 0 && (
                  <Text variant={"bodyLarge"}>
                    {item.applicableTo.products.length.toString() +
                      " Products  "}
                  </Text>
                )}
              ...
              <Text variant={"bodyLarge"}>
                Valid: {item.validity.startDate.toLocaleDateString()} -{" "}
                {item.validity.endDate.toLocaleDateString()}
              </Text>
            </View>
            {/*<Switch*/}
            {/*    value={item.isActive}*/}
      ...
      <ScrollView>
        <View style={{ marginVertical: 10 }}>
          ...
          >
            <Button
              onPress={() =>
                router.push("/Main/(tabs)/Offers/Offer/" + Crypto.randomUUID())
              }
              mode={"contained"}
              icon={"plus"}
              style={{
