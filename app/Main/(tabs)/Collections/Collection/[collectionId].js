import {Card, Chip, RadioButton, Surface, Switch, useTheme,} from "react-native-paper";
        ...
        return <Card style={{width: '100%', padding: 15, backgroundColor: 'white', marginBottom: 20}}>
            <View style={{width: '100%'}}>
                ...
                <View style={styles.radioButtonGroup}>
                    <RadioButton.Group onValueChange={(v) => setStoreFrontNumberOfItems(parseInt(v))} value={storeFrontNumberOfItems}>
