...
const CustomerDetails = () => {
    ...
    const mostRecentOrderDate = new Date(
        Math.max.apply(null, customer.orders.map((order) => new Date(order.orderDate)))
    );
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Card style={styles.section}>
                ...
                <Text style={styles.infoText}>Total Orders: {customer.orders.length}</Text>
                ...
                <View>
                    {customer.orders.map((order, index) => (
                        <View key={order.orderId}>
                            <Card style={styles.orderCard} onPress={() => router.push('/Main/(tabs)/Orders/Order/' + order.orderId)}>
