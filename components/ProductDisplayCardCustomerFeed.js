...
export default function ProductDisplayCardCustomerFeed(props) {
  const { textColor, oppositeColor } = foregroundColor(
    props.product.storeBrandColor,
  );
  ...
  return (
    <Card mode={"elevated"} style={styles.card}>
      <Card.Title
        ...
        left={() =>
          StoreLogo({ logoImage: props.product.storeLogoImage, size: 60 })
        }
        leftStyle={styles.titleLogoLeftStyle}
        style={{
          ...styles.titleComponentStyle,
          backgroundColor: props.product.storeBrandColor,
        }}
