...
const ProductInfoScreen = (props) => {
  ...
  }, [navigation, productData, dispatch, handleBeforeRemove]);
  ...
  useEffect(() => {
    ...
    return unsubscribe; // Cleanup listener
  }, [navigation, productData, dispatch, saveStateToReduxAndResetFormData]);
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.row}>
            ...
            <View ref={gstInputContainerRef} style={styles.gstInputContainer}>
              <TextInput
                ...
                right={
                  <TextInput.Icon icon="chevron-down" onPress={openGstMenu} />
                }
              />
            </View>
            {/* GST Rate Dropdown */}
        ...
        <View style={styles.section}>
          ...
          <Controller
            ...
            rules={{
              validate: (value) =>
                value.length > 0 || "At least one collection must be selected.",
            }}
            render={({ field: { value, onChange }, fieldState: { error } }) => (
              <View>
                <View
